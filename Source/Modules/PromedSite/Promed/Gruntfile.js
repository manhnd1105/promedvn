...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    // Project settings
      ...
      //              dest: 'styles', // Destination path prefix.
      ...
      //              dest: 'scripts', // Destination path prefix.
    ...
    watch: {
      ...
      compass: {
        ...
        tasks: ['compass:server', 'postcss:server', 'injector']
      },
      gruntfile: {
        files: ['Gruntfile.js']
      },
      //includeSource: {
      //    files: [
      //        '<%= yeoman.app %>/styles/{,*/}*.{scss,sass,css}',
      //        '<%= yeoman.app %>/scripts/{,*/}*.{js}'
      //    ],
    ...
    //  //Auto include custom CSS and JS files
    //includeSource: {
    //    options: {
    //        basePath: 'app',
    //        baseUrl: '/',
